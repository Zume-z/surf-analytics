...
const headToHeadBaseStats = async (ctx: Context, input: z.infer<typeof headToHeadStatSchema>) => {
  ...
  return { heatToHeadWins: { surferA: surferAWins, surferB: surferBWins } }
}
...
const headToHeadWin = async (ctx: Context, input: z.infer<typeof headToHeadStatSchema>) => {
  ...
  return { heatToHeadWins: { label: 'heatToHeadWins', surferA: surferAWins, surferB: surferBWins } }
}
...
const avgHeatTotal = async (ctx: Context, input: z.infer<typeof headToHeadStatSchema>) => {
  ...
  return { avgHeatTotal: { label: 'avgHeatTotal', surferA: surferAAvgHeatTotal, surferB: surferBAvgHeatTotal } }
}
...
const maxHeatTotal = async (ctx: Context, input: z.infer<typeof headToHeadStatSchema>) => {
  ...
  return { maxHeatTotal: { label: 'maxHeatTotal', surferA: surferAMaxHeatTotal, surferB: surferBMaxHeatTotal } }
}
...
const heatTotalDifferential = async (ctx: Context, input: z.infer<typeof headToHeadStatSchema>) => {
  ...
  return { heatTotalDifferential: { label: 'heatTotalDifferential', surferA: surferAHd, surferB: surferBHd } }
}
...
const totalWaves = async (ctx: Context, input: z.infer<typeof headToHeadStatSchema>) => {
  ...
  return { totalWaves: { label: 'totalWaves', surferA: surferAWaveCount, surferB: surferBWaveCount } }
}
...
const avgWaveScore = async (ctx: Context, input: z.infer<typeof headToHeadStatSchema>) => {
  ...
  return { avgWaveScore: { label: 'avgWaveScore', surferA: surferAAvgWaveScore, surferB: surferBAvgWaveScore } }
}
...
const maxWaveScore = async (ctx: Context, input: z.infer<typeof headToHeadStatSchema>) => {
  ...
  return { maxWaveScore: { label: 'maxWaveScore', surferA: surferAMaxWaveScore, surferB: surferBMaxWaveScore } }
}
...
const avgCountedWaveScore = async (ctx: Context, input: z.infer<typeof headToHeadStatSchema>) => {
  ...
  return { avgCountedWaveScore: { label: 'avgCountedWaveScore', surferA: surferAAvgWaveScore, surferB: surferBAvgWaveScore } }
}
...
const interferences = async (ctx: Context, input: z.infer<typeof headToHeadStatSchema>) => {
  ...
  return { interferences: { label: 'interferences', surferA: surferATotalInterferences, surferB: surferBTotalInterferences } }
}
