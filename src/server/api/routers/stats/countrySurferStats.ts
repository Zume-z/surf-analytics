...
const getAll = async (ctx: any, input: z.infer<typeof countryStatSchema>) => {
  const query = {
...
const getCountrySurfer = async (ctx: any, input: z.infer<typeof countryStatSchema>) => {
  const query = {
    ...(await worldTitles(ctx, input)),
    ...(await avgRank(ctx, input)),
    ...(await avgPoints(ctx, input)),
...
// ADD YEAR FILTER
const worldTitles = async (ctx: any, input: z.infer<typeof countryStatSchema>) => {
...
const avgRank = async (ctx: any, input: z.infer<typeof countryStatSchema>) => {
...
const avgPoints = async (ctx: any, input: z.infer<typeof countryStatSchema>) => {
...
// EVENTS //
const totalEvents = async (ctx: any, input: z.infer<typeof countryStatSchema>) => {
...
const eventWins = async (ctx: any, input: z.infer<typeof countryStatSchema>) => {
...
const eventWinPerc = async (ctx: any, input: z.infer<typeof countryStatSchema>) => {
...
const bestResult = async (ctx: any, input: z.infer<typeof countryStatSchema>) => {
...
const avgResult = async (ctx: any, input: z.infer<typeof countryStatSchema>) => {
...
// HEATS //
const totalHeats = async (ctx: any, input: z.infer<typeof countryStatSchema>) => {
...
const heatWins = async (ctx: any, input: z.infer<typeof countryStatSchema>) => {
...
const heatWinPerc = async (ctx: any, input: z.infer<typeof countryStatSchema>) => {
...
const avgHeatTotal = async (ctx: any, input: z.infer<typeof countryStatSchema>) => {
...
const highestHeatTotal = async (ctx: any, input: z.infer<typeof countryStatSchema>) => {
...
const heatTotalDifferential = async (ctx: any, input: z.infer<typeof countryStatSchema>) => {
...
const avgHeatTotalDifferential = async (ctx: any, input: z.infer<typeof countryStatSchema>) => {
...
const excellentHeats = async (ctx: any, input: z.infer<typeof countryStatSchema>) => {
...
// WAVES //
const totalWaves = async (ctx: any, input: z.infer<typeof countryStatSchema>) => {
...
const avgWaveScore = async (ctx: any, input: z.infer<typeof countryStatSchema>) => {
...
const totalCountedWaves = async (ctx: any, input: z.infer<typeof countryStatSchema>) => {
...
const avgCountedWaveScore = async (ctx: any, input: z.infer<typeof countryStatSchema>) => {
...
const highestWaveScore = async (ctx: any, input: z.infer<typeof countryStatSchema>) => {
...
const excellentWaves = async (ctx: any, input: z.infer<typeof countryStatSchema>) => {
...
// // OTHER
const prizeMoney = async (ctx: any, input: z.infer<typeof countryStatSchema>) => {
